...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = ROS2, SaveGame, meta = (EditInRuntime, ReactivateComponent))
	FROS2TopicSetup TopicSetup{ TEXT("{namespace}/tf/{dev_name}") };
	...
	UPROPERTY(EditAnywhere, Category = ROS2, SaveGame, meta = (EditInRuntime, ReactivateComponent, AllowedClasses = "/Script/UnrealSoda.SodaVehicleComponent"))
