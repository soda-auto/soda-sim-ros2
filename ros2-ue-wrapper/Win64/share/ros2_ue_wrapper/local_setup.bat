...
set "AMENT_ENVIRONMENT_HOOKS[ros2_ue_wrapper]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ros2_ue_wrapper] "%AMENT_CURRENT_PREFIX%\share\ros2_ue_wrapper\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ros2_ue_wrapper] "%AMENT_CURRENT_PREFIX%\share\ros2_ue_wrapper\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ros2_ue_wrapper]:;=";"%") do (
    call:call_file %%f
  )
