...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\ros2_ue_wrapper\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\ros2_ue_wrapper\hook\path_dll.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\ros2_ue_wrapper\hook\path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/ros2_ue_wrapper/local_setup.bat"
